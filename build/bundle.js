...
var LitElement = function (_PropertiesMixin) {
    ...
    createClass(LitElement, [{
        ...
        value: function _propertiesChanged(props, changedProps, prevProps) {
            ...
            var result = this.render(props);
            if (result && this._root !== undefined) {
                render$1(result, this._root, this.localName);
            }
        ...
        key: 'didRender',
        value: function didRender(_props, _changedProps, _prevProps) {}
        /**
        ...
        get: function get$$1() {
            ...
            if (!this.__renderComplete) {
                ...
                this.__renderComplete = new Promise(function (resolve) {
                    _this2.__resolveRenderComplete = function () {
...
var LitTest = function (_LitElement) {
  inherits(LitTest, _LitElement);
  createClass(LitTest, null, [{
    key: 'properties',
  ...
  function LitTest() {
    ...
    classCallCheck(this, LitTest);

    var _this = possibleConstructorReturn(this, (LitTest.__proto__ || Object.getPrototypeOf(LitTest)).call(this));
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _this.whales++;
                _context.next = 3;
                return _this.renderComplete;

              case 3:
                _this.dispatchEvent(new CustomEvent('whales', { detail: { whales: _this.whales } }));
  ...
  createClass(LitTest, [{
    ...
    value: function render(_ref2) {
      ...
      return html$1(_templateObject, foo, '🐳'.repeat(whales));
    }
  }]);
  return LitTest;
}(LitElement);
